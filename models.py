...
class Product(db.Model):
    ...
    price_premium = db.Column(db.Float, nullable=True)
    description = db.Column(db.Text, nullable=True)
    image_url = db.Column(db.Text, nullable=True)
    image_url_black = db.Column(db.Text, nullable=True)
    image_url_brown = db.Column(db.Text, nullable=True)
    image_url_cream = db.Column(db.Text, nullable=True)
